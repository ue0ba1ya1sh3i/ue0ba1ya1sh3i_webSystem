...
root.get("/:id", (req,res) => {
    ...
    .then(response => {
        ...
        if(hour > 18 | hour < 6) {
            var weatherCode = "https://www.jma.go.jp/bosai/forecast/img/" + weatherGraph[deta.weatherCodes[0]][0];
        } else {
            var weatherCode = "https://www.jma.go.jp/bosai/forecast/img/" + weatherGraph[deta.weatherCodes[0]][1];
        };

        //メッセージ
        var message = weatherGraph[deta.weatherCodes[0]][3];
